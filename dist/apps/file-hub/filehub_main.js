// File Hub Logic - Unified Vanilla Version (filehub.js)
...
window.connectDrive = () => {
    if (tokenClient) {
        ...
        alert("Authentication system is still loading. Please wait a moment.");
    }
};
    ...
    if (filtered.length === 0) {
        container.innerHTML = `
            <div class="empty-state">
                ...
                <p style="font-size: 13px;">Connect your drive to begin.</p>
            </div>
        `;
        return;
    }
